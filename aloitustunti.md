# Kurssin aloitustunnin muistiinpanot
...
**Kurssin ensimmäisellä viikolla tavoittena on löytää aihe ja dataa**, joka tarjoaa sopivasti haastetta ja kiinnostaa useampaa opiskelijaa loppukurssin ajan. Lähdemmekin siitä liikkeelle **mitä te haluatte kurssilla oppia**.

**Alustavan ideoinnin ja kartoituksen jälkeen jakaudumme tiimeihin.** Ideoinnin tueksi Käymme läpi esimerkkejä [aikaisemmista opintojaksoista](./aiempia-projekteja.md).

Tarkempaa ideaa ja konseptia ehditään tarkentamaan seuraavalla viikolla, kun tiimit on koottu. Projektin suunnittelussa Tässä hyödynnämme define-vaihetta, jota käsitellään tarkemmin torstain tunnilla.

Olemme siirtymässä hiljalleen Moodlesta GitHubiin sekä Teamsiin. Moodleen ei tämän hetken vision mukaan ole tulossa merkittävästi sisältöä.
...
Opettajien rooli on neuvoa sivusta, mutta ei tehdä projektiin liittyviä päätöksiä tai linjauksia. Ryhmille ei voida tarjota suoraan opetusta heidän valitsemistaan "eksoottisemmista" teknologioista, vaikka olemme käytettävissä myös uuden teknologian ongelmien ratkomisessa.
...
Kurssin arviointi perustuu ryhmätyöskentelyyn, ryhmän lopullisen tuloksen tarkoituksenmukaiseen toimivuuteen sekä itsenäisesti kirjoitettavaan loppuarviointiin, jossa arvioidaan omaa ja ryhmän toimintaa. Loppuarviointi sisältää myös vertaisarvioinnit kaikista tiimiläisistä.
...
Esimerkkejä avoimen lähdekoodin ohjelmistoista, joita olette jo käyttäneet:
...
## Kurssin projekteihin soveltuvia  teknologioita
...
# Tekninen tukikurssi: ohjelmistokehityksen teknologioita
...
* Jakautuminen ryhmiin saman aihepiirin ympärille
...
* Bussitutka.fi
* Sanuli
* Vaalit? (Ylen vaalikonedata)
* Ilmatieteen laitos
* Avoimen datan lisäksi on olemassa myös muuta dataa, jonka varaan palveluita voidaan rakentaa. Syksyllä eräs opiskelija teki ohjelmiston joka käsitteli Spotify:n dataa, joka oli saatu GDPR:n mukaisen pyynnön kautta.
